...
const SubtrackFeatureRenderer = ConfigurationSchema(
  'SubtrackFeatureRenderer',
  {
    ...
    subtracks: {
      type: 'frozen',
      description:
        'Array of subtrack definitions with filters and metadata. Each subtrack can filter features based on their attributes.',
      defaultValue: [],
    },
    ...
    subtrackConfig: ConfigurationSchema('SubtrackConfiguration', {
      /**
       * #slot subtrackConfig.enabled
       */
      enabled: {
        type: 'boolean',
        description: 'Enable subtrack functionality',
        defaultValue: false,
      },
      /**
       * #slot subtrackConfig.perSubtrackHeight
       */
      perSubtrackHeight: {
        type: 'integer',
      ...
      spacing: {
        type: 'integer',
        description: 'Gap in pixels between subtracks',
        defaultValue: 5,
      },
      /**
       * #slot subtrackConfig.showLabels
       */
      showLabels: {
        type: 'boolean',
        description: 'Whether to show subtrack labels',
        defaultValue: true,
      },
    }),
  },
...
export default SubtrackFeatureRenderer
