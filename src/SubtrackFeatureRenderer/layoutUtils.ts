...
function findMatchingGlyph(
  ...
  // Note: getGlyphTypes may not be available in web worker context
  if (pluginManager && typeof pluginManager.getGlyphTypes === 'function') {
    try {
      ...
      // Silently ignore if glyphs aren't available in worker context
    }
  }
